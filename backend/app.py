...
def get_tasks():
    ...
    with tracer.start_as_current_span("get_all_tasks") as span:
        try:
            ...
            database_query_duration.record(
                query_duration_time, {"operation": "select", "table": "tasks"}
            )
...
def get_task(task_id):
    ...
    with tracer.start_as_current_span("get_task_by_id") as span:
        ...
        try:
            ...
            database_query_duration.record(
                query_duration_time, {"operation": "select_by_id", "table": "tasks"}
            )
...
def create_task():
    ...
    with tracer.start_as_current_span("create_task") as span:
        try:
            ...
            database_query_duration.record(
                query_duration_time, {"operation": "insert", "table": "tasks"}
            )
...
def update_task(task_id):
    ...
    with tracer.start_as_current_span("update_task") as span:
        ...
        try:
            ...
            database_query_duration.record(
                query_duration_time, {"operation": "update", "table": "tasks"}
            )
...
def delete_task(task_id):
    ...
    with tracer.start_as_current_span("delete_task") as span:
        ...
        try:
            ...
            database_query_duration.record(
                query_duration_time, {"operation": "delete", "table": "tasks"}
            )
...
def db_smoke():
    ...
    insert_stmt = text(
        "INSERT INTO tasks (title, description, completed, created_at) VALUES (:t, :d, :c, :dt)"
    )
    ...
    try:
        ...
        logger.info(
            f"DB smoke test completed: {read_ops} reads, {write_ops} writes (rolled back)"
        )
